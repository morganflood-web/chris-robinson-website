    ...
    <div>
      ...
      <section style={s.card}>
        ...
        <form onSubmit={handleAdd} style={s.formGrid}>
          <Field label="Date" name="date" placeholder="Thu, May 1, 2026" required />
          <Field label="Venue" name="venue" placeholder="Brewery Bay" required />
          <Field label="City" name="city" placeholder="Orillia, ON" required />
